[assembly: Xamarin.Forms.ExportRenderer(typeof(mapasycirculos.MapCustomPin), typeof(mapasycirculos.Droid.MapCustomPinRenderer))]
namespace mapasycirculos.Droid
{
	using Android.Content;
	using Android.Gms.Maps;
	using Android.Gms.Maps.Model;
	using mapasycirculos;
	using ReactiveUI;
	using System;
	using System.Linq;
    ...
    public class MapCustomPinRenderer : MapRenderer
	{
		...
		private MarkerOptions CreateUserMarker()
		{
			...
			userMarkerOptions.SetPosition(new LatLng(lastLocation?.Latitude ?? 40, lastLocation?.Longitude ?? 12));
			userMarkerOptions.SetTitle("UserPostion");
			userMarkerOptions.SetIcon(BitmapDescriptorFactory.FromResource(Resource.Drawable.point));
