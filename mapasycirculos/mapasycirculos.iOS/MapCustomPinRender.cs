[assembly: Xamarin.Forms.ExportRenderer(typeof(mapasycirculos.MapCustomPin), typeof(mapasycirculos.iOS.MapCustomPinRenderer))]
namespace mapasycirculos.iOS
{
	using CoreGraphics;
	using CoreLocation;
	using MapKit;
	...
	public class MapCustomPinRenderer : MapRenderer
	{
		...
		protected override MKAnnotationView GetViewForAnnotation(MKMapView mapView, IMKAnnotation annotation)
		{
			...
			if (annotationView == null)
			{
				...
				annotationView.Image = UIImage.FromFile("point.png");
